...
const Navbar = () => {
  ...
  return (
    <nav className="flex flex-wrap items-center justify-between bg-indigo-950 py-6 px-9">
      {/* TITLE */}
      <div className="flex items-center text-slate-200 tracking-tight font-serif font-semibold text-lg my-1">Book Catalogue</div>
      {/* LINKS - LARGE WINDOW */}
      <div className="max-md:hidden block text-slate-400">
        <NavLinkSet/>
      </div>
      {/* LINKS - SMALL WINDOW */}
      ...
      {
        isVisible ? (
          <div className="md:hidden w-full block items-center mt-5 me-1 text-slate-400">
